...
const BLIND_ROOT = joinpath(ROOT, "fig4", "benchmark", "datasets", "atomly_core_v2", "native_blind_package_v2")
const INPUT_ROOT = joinpath(ROOT, "fig4", "benchmark", "method_inputs", "crystalshift_cod_v2")
const COD_ROOT = joinpath(ROOT, "fig4", "benchmark", "method_inputs", "cod_native_v2")
const RESULT_ROOT = joinpath(ROOT, "fig4", "benchmark", "results", "atomly_core_v2", "crystaltree_cod_frontend")
        ...
        try
            ...
            for (phase_rank, position) in enumerate(phase_order)
                ...
                push!(predictions, Dict(
                    ...
                    "predicted_database_id" => filename,
                    ...
                    "predicted_cif_path" => joinpath("fig4", "benchmark", "method_inputs", "cod_native_v2", key, "cifs", filename),
                ))
            end
            push!(records, Dict(
                "sample_id" => sample_id,
